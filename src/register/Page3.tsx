...
const Page3Component: React.FC<Page3ComponentProps> = ({ setPage3Register, page3Register }) => {
  ...
  const options = ['אני מתעניינת ב-5 יח"ל מכטרוניקה', 'אני מתעניינת ב-10 יח"ל מכטרוניקה', 'עדיין לא ידוע', 'אחרת'];
  return (
    <Box
      component="form"
      ...
      <FormControl component="fieldset" required>
        <RadioGroup value={page3Register.numStudyUnitsMath} onChange={handleChange}>
